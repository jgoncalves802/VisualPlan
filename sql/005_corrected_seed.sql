-- VisionPlan Corrected Seed Data
-- Uses existing empresa, eps_nodes IDs and correct constraint values
-- empresa: a0000001-0000-0000-0000-000000000001
-- eps_nodes: c0000001, c0000002, c0000003 (these are used as projeto_id in some tables!)
-- projetos: d0000001, d0000002, d0000003 (for atividades_cronograma)

-- ========================================
-- USUARIOS - Use VALID perfil_acesso values from check constraint
-- Valid: ADMIN, DIRETOR, GERENTE_PROJETO, ENGENHEIRO_PLANEJAMENTO, COORDENADOR_OBRA, 
--        MESTRE_OBRAS, ENCARREGADO, COLABORADOR, FISCALIZACAO_LEAD, FISCALIZACAO_TECNICO
-- ========================================
INSERT INTO usuarios (id, nome, email, empresa_id, camada_governanca, perfil_acesso, ativo) VALUES
  ...
  ('b0000002-0000-0000-0000-000000000002'::uuid, 'Maria Santos', 'maria.santos@visionplan.com.br', 'a0000001-0000-0000-0000-000000000001'::uuid, 'CONTRATADA', 'GERENTE_PROJETO', true),
  ('b0000003-0000-0000-0000-000000000003'::uuid, 'Carlos Lima', 'carlos.lima@visionplan.com.br', 'a0000001-0000-0000-0000-000000000001'::uuid, 'CONTRATADA', 'COORDENADOR_OBRA', true),
  ('b0000004-0000-0000-0000-000000000004'::uuid, 'Ana Costa', 'ana.costa@visionplan.com.br', 'a0000001-0000-0000-0000-000000000001'::uuid, 'FISCALIZACAO', 'FISCALIZACAO_LEAD', true),
  ('b0000005-0000-0000-0000-000000000005'::uuid, 'Pedro Souza', 'pedro.souza@visionplan.com.br', 'a0000001-0000-0000-0000-000000000001'::uuid, 'FISCALIZACAO', 'FISCALIZACAO_TECNICO', true),
  ('b0000006-0000-0000-0000-000000000006'::uuid, 'Fernanda Oliveira', 'fernanda.oliveira@visionplan.com.br', 'a0000001-0000-0000-0000-000000000001'::uuid, 'CONTRATADA', 'ENGENHEIRO_PLANEJAMENTO', true),
  ('b0000007-0000-0000-0000-000000000007'::uuid, 'Roberto Dias', 'roberto.dias@visionplan.com.br', 'a0000001-0000-0000-0000-000000000001'::uuid, 'CONTRATADA', 'MESTRE_OBRAS', true),
  ('b0000008-0000-0000-0000-000000000008'::uuid, 'Luciana Ferreira', 'luciana.ferreira@visionplan.com.br', 'a0000001-0000-0000-0000-000000000001'::uuid, 'PROPONENTE', 'DIRETOR', true)
...
-- ========================================
-- ATIVIDADES DO CRONOGRAMA - Use projetos table d0000001
-- ========================================
INSERT INTO atividades_cronograma (id, projeto_id, codigo, nome, descricao, tipo, wbs_id, data_inicio, data_fim, duracao_dias, progresso, status, responsavel_id, responsavel_nome, empresa_id) VALUES
  ...
  ('f0000002-0000-0000-0000-000000000002'::uuid, 'd0000001-0000-0000-0000-000000000001'::uuid, 'ATIV-002', 'Escavação Fundações', 'Escavação mecânica', 'Tarefa', 'e0000001-0000-0000-0000-000000000001'::uuid, '2025-01-21', '2025-02-10', 20, 100, 'concluida', 'b0000003-0000-0000-0000-000000000003'::uuid, 'Carlos Lima', 'a0000001-0000-0000-0000-000000000001'::uuid),
...
-- ========================================
-- AUDITORIAS - projeto_id references eps_nodes, use c0000001
-- ========================================
INSERT INTO auditorias (id, codigo, titulo, tipo, template_id, projeto_id, projeto_nome, local_auditoria, data_programada, data_realizacao, auditor_id, auditor_nome, status, itens, total_itens, itens_conformes, itens_nao_conformes, nota_geral, observacoes, empresa_id, created_by) VALUES
  ('22222222-2222-2222-2222-222222222201'::uuid, 'AUD-2025-001', 'Auditoria de Segurança - Janeiro', 'interna', '11111111-1111-1111-1111-111111111101'::uuid, 'c0000001-0000-0000-0000-000000000001'::uuid, 'Residencial Torre Alpha', 'Canteiro de obras', '2025-01-25', '2025-01-25', 'b0000005-0000-0000-0000-000000000005'::uuid, 'Pedro Souza', 'concluida',
   ...
   6, 5, 1, 83.33, 'Auditoria concluída com uma não conformidade', 'a0000001-0000-0000-0000-000000000001'::uuid, 'b0000005-0000-0000-0000-000000000005'::uuid),

  ('22222222-2222-2222-2222-222222222202'::uuid, 'AUD-2025-002', 'Controle de Qualidade - Concretagem', 'interna', '11111111-1111-1111-1111-111111111102'::uuid, 'c0000001-0000-0000-0000-000000000001'::uuid, 'Residencial Torre Alpha', 'Fundações - Bloco A', '2025-02-15', '2025-02-15', 'b0000004-0000-0000-0000-000000000004'::uuid, 'Ana Costa', 'concluida',
   '[{"id": "ai-1", "itemId": "item-1", "descricao": "Nota fiscal do concreto verificada", "status": "conforme"},
     ...
     {"id": "ai-4", "itemId": "item-4", "descricao": "Armaduras conferidas", "status": "conforme"},
   ...
   6, 6, 0, 100.00, 'Processo de concretagem conforme', 'a0000001-0000-0000-0000-000000000001'::uuid, 'b0000004-0000-0000-0000-000000000004'::uuid),

  ('22222222-2222-2222-2222-222222222203'::uuid, 'AUD-2025-003', 'Auditoria de Segurança - Fevereiro', 'interna', '11111111-1111-1111-1111-111111111101'::uuid, 'c0000001-0000-0000-0000-000000000001'::uuid, 'Residencial Torre Alpha', 'Canteiro de obras', '2025-02-28', NULL, 'b0000005-0000-0000-0000-000000000005'::uuid, 'Pedro Souza', 'em_andamento',
   '[{"id": "ai-1", "itemId": "item-1", "descricao": "EPIs disponíveis", "status": "conforme"},
     {"id": "ai-2", "itemId": "item-2", "descricao": "Sinalização adequada", "status": "conforme"},
     {"id": "ai-3", "itemId": "item-3", "descricao": "Extintores acessíveis", "status": "conforme"}]',
   6, 3, 0, 50.00, NULL, 'a0000001-0000-0000-0000-000000000001'::uuid, 'b0000005-0000-0000-0000-000000000005'::uuid),

  ('22222222-2222-2222-2222-222222222204'::uuid, 'AUD-2025-004', 'Inspeção Alvenaria Térreo', 'interna', '11111111-1111-1111-1111-111111111103'::uuid, 'c0000002-0000-0000-0000-000000000002'::uuid, 'Centro Comercial Plaza', 'Pavimento Térreo', '2025-03-10', NULL, 'b0000002-0000-0000-0000-000000000002'::uuid, 'Maria Santos', 'programada',
   '[]', 5, 0, 0, NULL, NULL, 'a0000001-0000-0000-0000-000000000001'::uuid, 'b0000002-0000-0000-0000-000000000002'::uuid),

  ('22222222-2222-2222-2222-222222222205'::uuid, 'AUD-2025-005', 'Auditoria Externa ISO 9001', 'externa', '11111111-1111-1111-1111-111111111102'::uuid, 'c0000001-0000-0000-0000-000000000001'::uuid, 'Residencial Torre Alpha', 'Escritório e Canteiro', '2025-04-15', NULL, NULL, 'Auditor Externo', 'programada',
   '[]', 6, 0, 0, NULL, 'Auditoria de certificação SGQ', 'a0000001-0000-0000-0000-000000000001'::uuid, 'b0000001-0000-0000-0000-000000000001'::uuid)
ON CONFLICT (id) DO NOTHING;

-- ========================================
-- SOLICITACOES DE MUDANCA - projeto_id references eps_nodes
-- ========================================
INSERT INTO solicitacoes_mudanca (id, codigo, titulo, descricao, justificativa, tipo_mudanca, prioridade, solicitante, solicitante_id, data_solicitacao, status, projeto_id, projeto_nome, impacto_cronograma, impacto_custo, impacto_estimado, historico, empresa_id, created_by) VALUES
  ('33333333-3333-3333-3333-333333333301'::uuid, 'SM-2025-001', 'Alteração de Fundação - Bloco B', 'Mudança de sapata para estaca raiz', 'Argila mole não prevista', 'escopo', 'alta', 'Maria Santos', 'b0000002-0000-0000-0000-000000000002'::uuid, '2025-01-28', 'aprovada', 'c0000001-0000-0000-0000-000000000001'::uuid, 'Residencial Torre Alpha', 15, 85000.00, 'alto',
...
-- ========================================
-- RESTRICOES ISHIKAWA - projeto_id references projetos table
-- ========================================
...
-- ========================================
-- ACOES 5W2H - projeto_id references eps_nodes
-- ========================================
...
-- ========================================
-- RESTRICOES LPS - projeto_id references eps_nodes
-- ========================================
INSERT INTO restricoes_lps (id, empresa_id, projeto_id, codigo, descricao, categoria, status, prioridade, responsavel_id, responsavel_nome, data_identificacao, data_prevista, data_resolucao, atividade_id, wbs_id, impacto_cronograma, impacto_custo, observacoes, created_by) VALUES
  ...
  ('77777777-7777-7777-7777-777777777704'::uuid, 'a0000001-0000-0000-0000-000000000001'::uuid, 'c0000001-0000-0000-0000-000000000001'::uuid, 'LPS-004', 'Equipamento de vibração indisponível', 'equipamento', 'identificada', 'media', 'b0000007-0000-0000-0000-000000000007'::uuid, 'Roberto Dias', '2025-02-25', '2025-02-28', NULL, 'f0000004-0000-0000-0000-000000000004'::uuid, 'e0000001-0000-0000-0000-000000000001'::uuid, 2, 3000, NULL, 'b0000007-0000-0000-0000-000000000007'::uuid),
  
  ('77777777-7777-7777-7777-777777777705'::uuid, 'a0000001-0000-0000-0000-000000000001'::uuid, 'c0000001-0000-0000-0000-000000000001'::uuid, 'LPS-005', 'Condições climáticas adversas previstas', 'outros', 'em_tratamento', 'media', 'b0000008-0000-0000-0000-000000000008'::uuid, 'Luciana Ferreira', '2025-02-26', '2025-03-02', NULL, 'f0000004-0000-0000-0000-000000000004'::uuid, 'e0000001-0000-0000-0000-000000000001'::uuid, 3, 0, 'Monitorando previsão do tempo', 'b0000008-0000-0000-0000-000000000008'::uuid),
  
  ('77777777-7777-7777-7777-777777777706'::uuid, 'a0000001-0000-0000-0000-000000000001'::uuid, 'c0000001-0000-0000-0000-000000000001'::uuid, 'LPS-006', 'Liberação de área pelo cliente pendente', 'projeto', 'identificada', 'baixa', 'b0000001-0000-0000-0000-000000000001'::uuid, 'João Silva', '2025-02-28', '2025-05-20', NULL, 'f0000009-0000-0000-0000-000000000009'::uuid, 'e0000004-0000-0000-0000-000000000004'::uuid, 0, 0, 'Atividade futura - acompanhar', 'b0000001-0000-0000-0000-000000000001'::uuid),
  
  ('77777777-7777-7777-7777-777777777707'::uuid, 'a0000001-0000-0000-0000-000000000001'::uuid, 'c0000001-0000-0000-0000-000000000001'::uuid, 'LPS-007', 'Contrato com subempreiteiro em negociação', 'mao_de_obra', 'em_tratamento', 'media', 'b0000001-0000-0000-0000-000000000001'::uuid, 'João Silva', '2025-02-28', '2025-08-15', NULL, 'f0000011-0000-0000-0000-000000000011'::uuid, 'e0000005-0000-0000-0000-000000000005'::uuid, 0, 0, 'Negociação em andamento', 'b0000001-0000-0000-0000-000000000001'::uuid),
  
  ('77777777-7777-7777-7777-777777777708'::uuid, 'a0000001-0000-0000-0000-000000000001'::uuid, 'c0000001-0000-0000-0000-000000000001'::uuid, 'LPS-008', 'Definição de cores pelo cliente pendente', 'projeto', 'identificada', 'baixa', 'b0000006-0000-0000-0000-000000000006'::uuid, 'Fernanda Oliveira', '2025-02-28', '2025-10-10', NULL, 'f0000012-0000-0000-0000-000000000012'::uuid, 'e0000005-0000-0000-0000-000000000005'::uuid, 0, 0, 'Reunião agendada com cliente', 'b0000006-0000-0000-0000-000000000006'::uuid)
ON CONFLICT (id) DO NOTHING;
