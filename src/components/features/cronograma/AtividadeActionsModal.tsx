/**
 * AtividadeActionsModal - Modal de ações para atividades do cronograma
        ...
        <div className="p-6">
          ...
          <div className="mb-6">
            ...
            {atividade.data_inicio && atividade.data_fim && (
              <p className="text-sm text-gray-600 mb-1">
                Período: {new Date(atividade.data_inicio).toLocaleDateString('pt-BR')} - {new Date(atividade.data_fim).toLocaleDateString('pt-BR')}
              </p>
            )}
          </div>
