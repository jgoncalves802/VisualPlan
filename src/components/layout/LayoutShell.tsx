...
export const LayoutShell: React.FC<LayoutShellProps> = ({
  ...
  return (
    <div className="h-screen flex theme-bg-background overflow-hidden">
      <aside 
        className={`
          ...
          theme-surface border-r theme-border-primary flex-shrink-0
        `}
      >
            ...
            {sidebarOpen && (
              <div className="flex items-center space-x-2">
                ...
                <div className="flex flex-col">
                  ...
                  {subtitle && (
                    <span className="text-xs font-medium" style={{ color: bgColor }}>{subtitle}</span>
                  )}
                </div>
              </div>
            )}
      ...
      <main className="flex-1 flex flex-col overflow-hidden">
        <header className="theme-surface border-b theme-border-primary px-6 py-4 flex-shrink-0">
            ...
            <div className="flex items-center space-x-4 ml-auto">
              {isAdmin && (
                <button
                  ...
                  style={adminMode ? { backgroundColor: '#6366f1' } : {}}
