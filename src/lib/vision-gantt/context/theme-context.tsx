...
export type GanttThemeName = 'Professional' | 'Modern' | 'Clean' | 'P6 Classic' | 'Dark' | 'Construction' | 'Empresa';
...
export function GanttThemeProvider({
  ...
  const availableThemes: GanttThemeName[] = useMemo(() => {
    const themes: GanttThemeName[] = ['Professional', 'Modern', 'Clean', 'P6 Classic', 'Dark', 'Construction'];
    if (companyTheme) {
...
export function useGanttTheme(): GanttThemeContextValue {
  ...
  if (!context) {
    return {
      ...
      availableThemes: ['Professional', 'Modern', 'Clean', 'P6 Classic', 'Dark', 'Construction'],
      setTheme: () => {},
      setThemeByName: () => {},
      setCompanyColors: () => {},
