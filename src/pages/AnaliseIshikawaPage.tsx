...
const generateMockRestrictions = (): RestricaoIshikawa[] => {
  const restrictions: RestricaoIshikawa[] = [
    ...
    // JANEIRO 2026 - Semana 2 (08-14)
    { id: '34', codigo: 'REST-034', descricao: 'Compatibilização BIM pendente', categoria: CategoriaIshikawa.METODO, status: StatusRestricaoIshikawa.EM_EXECUCAO, atividadeId: 'A002', atividadeNome: 'Montagem Estrutura', wbsId: 'WBS-01', wbsNome: 'Estrutura', epsId: 'EPS-01', epsNome: 'Edifício Principal', dataCriacao: new Date('2026-01-02'), dataPrevista: new Date('2026-01-12'), responsavel: 'Maria Santos', impactoCaminhoCritico: true, duracaoAtividadeImpactada: 12, diasAtraso: 0, scoreImpacto: 45, reincidente: false },
    { id: '35', codigo: 'REST-035', descricao: 'Contratação de mão de obra especializada', categoria: CategoriaIshikawa.MAO_DE_OBRA, status: StatusRestricaoIshikawa.EM_EXECUCAO, atividadeId: 'A006', atividadeNome: 'Pintura Externa', wbsId: 'WBS-04', wbsNome: 'Acabamento', epsId: 'EPS-01', epsNome: 'Edifício Principal', dataCriacao: new Date('2026-01-03'), dataPrevista: new Date('2026-01-10'), responsavel: 'Lucas Ferreira', impactoCaminhoCritico: false, duracaoAtividadeImpactada: 10, diasAtraso: 0, scoreImpacto: 25, reincidente: false },
    { id: '16', codigo: 'REST-016', descricao: 'Tubulação PVC fora de estoque', categoria: CategoriaIshikawa.MATERIAL, status: StatusRestricaoIshikawa.ATRASADA, atividadeId: 'A015', atividadeNome: 'Instalações Hidrossanitárias', wbsId: 'WBS-03', wbsNome: 'Instalações', epsId: 'EPS-02', epsNome: 'Bloco B', dataCriacao: new Date('2026-01-02'), dataPrevista: new Date('2026-01-08'), responsavel: 'Lucas Ferreira', impactoCaminhoCritico: false, duracaoAtividadeImpactada: 8, diasAtraso: 6, scoreImpacto: 22, reincidente: false },
